...
public final class Dictionary extends Table {
  ...
  public Entry entries(Entry obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int entriesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public Entry entriesByKey(String key) { int o = __offset(4); return o != 0 ? Entry.__lookup_by_key(__vector(o), key, bb) : null; }
